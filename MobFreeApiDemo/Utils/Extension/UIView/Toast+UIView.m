...
- (void)makeToastActivityAndMsg:(NSString*)msg {
    [self makeToastActivity:CSToastActivityDefaultPosition andMsg:msg];
}

- (void)makeToastActivity:(id)position andMsg:(NSString*)msg{
    // sanity
    ...
    [lab setFrame:CGRectMake(CSToastActivityWidth/2-15, CSToastActivityWidth-8, 200, 20)];
